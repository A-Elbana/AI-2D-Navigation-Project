...
class Agent:
    def __init__(self) -> None:
        ...
        self.model = Linear_QNet(9, 30,4)
        self.trainer = QTrainer(self.model, LEARNING_RATE, self.gamma)

    def get_state(self, game: AgarGame):
        position = game.pos
        food_down, food_right, food_up, food_left = 0, 0, 0, 0
        wall_right, wall_left, wall_up, wall_down = 0,0,0,0
        if game.food[0]  > position[0] + 30:
            food_right = 1
        if game.food[1] > position[1]  + 30 :
            food_down = 1
        ...
        state = [food_left, food_right, food_up, food_down, wall_right, wall_left, wall_up, wall_down, d_to_food/800]
        game.state = state
